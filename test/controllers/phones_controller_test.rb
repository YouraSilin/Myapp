...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference("Phone.count") do
      post phones_url, params: { phone: { colour: @phone.colour, department: @phone.department, name: @phone.name, number: @phone.number, position: @phone.position } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { colour: @phone.colour, department: @phone.department, name: @phone.name, number: @phone.number, position: @phone.position } }
